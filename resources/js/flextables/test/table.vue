...
<template>
  <div class="">
    <section v-if="loadDataComplete">
      ...
      <div class="mb-2" v-for="(row, rowindex) in copyTableData" :key="rowindex"      v-on:dblclick="invokePopup(rowindex, row, $event)">
        <div
...
export default {
  ...
  methods: {
    ...
    invokePopup:function(index, rowobj, event)
    {
        if(this.popupEdit &&  this.popupEditType == "inline")
        {
              
              this.openPopInline(index);
        }
        else if(this.popupEdit &&  this.popupEditType == "modal")
        {
              this.openPopModal(index, rowobj, event);
        }
      

    },
    openPopInline:function(index, rowobj, event)
    {
      var exobj ={};
     ...
     openPopModal:function(index, rowobj, event)
    {
